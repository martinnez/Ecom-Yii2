...
<?= 
	GridView::widget([
        'dataProvider' => $data,
        'layout' => "<div class='pull-left'>".Html::submitButton('<span class="glyphicon glyphicon-plus" aria-hidden="true" href="#"></span> '.$create['label'], ['name' => 'create', 'class' => 'btn btn-success', 'value' => $create['product_id']])."</div><div class='pull-right'>{summary}</div>\n<div class='clearfix'>{items}</div>\n{pager}",
        'columns' => [
            ...
            [
            	...
            	'format' => 'raw',
            	'value' =>function($data){
            			return Html::img(Yii::$app->request->baseUrl.'/uploads/products/'.Html::encode($data -> url), ['width' => '150px']);
           		},
